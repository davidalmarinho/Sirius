...
public class Scanner {
    private static File recursiveFile;
    ...
    /**
     * Checks if the content of a file has a String.
     * This method replaces file's content with two or more white spaces and non-visible characters with a single space
     *
    ...
    public static boolean hasString(File file, String str) {
        String content = readFile(file.getPath()).replaceAll("\\s+", " ");
